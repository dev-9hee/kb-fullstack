...
public class BoardController {
    ...
    public String create(
            ...
            // @ModelAttribute Board board // 일일이 param 을 안 받아도 됨, 좀 더 심플
    ) {
        // 여기 부분에 코드를 완성하여, 게시글 작성 기능을 완성시켜 주세요
        Board newBoard = new Board(null,title, content, author,null);
...
//        Board updateBoard = new Board(id, title, content, author, null);
